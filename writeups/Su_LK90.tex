% for i in ../scripts/lk90/5_dWs_inner.png ../scripts/lk90/5_dWs.png ../scripts/lk90/6toy/6_poincare_inner88.png ../scripts/lk90/6toy/6_poincare_inner.png ../scripts/lk90/4sims_scan/deviations_one.png ../scripts/lk90/4sims/4sim_90_350.png ../scripts/lk90/4sims/4sim_90_350.png ../scripts/lk90/7_3vec_cropped.png ../scripts/lk90/4sims/good_quants.png; do cp $i LK90_plots; done
    \documentclass[
        twocolumn,
        twocolappendix
    ]{aastex63}
...
%     \caption{Ratio $\Omega_{\rm e} / \Omega$ for the two parameter
%     regimes.}\label{fig:dWs}
% \end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\columnwidth]{LK90_plots/6_poincare_inner.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\columnwidth]{LK90_plots/6_poincare_inner88.png}
