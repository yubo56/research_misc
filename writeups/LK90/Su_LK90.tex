...
\end{equation}
Suppose additionally that $\abs{\overline{\Omega}_{\rm L, i}} \gg
...
sign (for the present parameters, $I_{\rm c} \approx 92.14^\circ$). Note that
even though $\Omega_{\rm L}$ changes sign at $I = 90^\circ$ [see
...
$I_{\rm c}$. This is because $\abs{\Omega}_{\rm L}$ is not exactly equal on
...
\begin{figure}
    ...
    c} \approx 92.14^\circ$, the inclination for which $\overline{\Omega}_{\rm L}$
...
\begin{figure}
    ...
    adiabaticity parameter $\mathcal{A}$, where red denotes $\mathcal{A} < 0$.
    In the second panel, we show the ratio of the magnitude of the averaged
    precession vector to the LK frequency; we expect resonant effects (see
    Section~TODO) when $\overline{\Omega}_{\rm e} \approx N\Omega_{\rm LK}$. The
    third panel shows the magnitude of the angle between the eigenvector of the
    monodromy matrix (see Section~\ref{ss:monodromy}) and the averaged
    precession vector, as well as the effect of the first two resonant harmonics
