...
def plot_905(t_slice=np.s_[::], fn='4sims/4sim_lk_90_500.pkl',
    ...
    ax2.set_ylabel(r'$\Omega_{\rm eff} t_{\rm LK, i}$')
    ax2.set_xlabel(r'$t / t_{\rm LK, i}$')
    plt.tight_layout()
...
if __name__ == '__main__':
    ...
    #                 title=r'Paper I, $I_{\rm i} = 70^\circ$')
    ...
    #                         I0=np.radians(88),
    #                         title=r'Paper I, $I_{\rm i} = 88^\circ$',
    #                         n_ratios=50)
