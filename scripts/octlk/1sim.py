...
def sweep(num_trials=20, num_i=200, t_hubb_gyr=10):
    ...
    for q, fn, ilow, ihigh in [
            [1.0, '1sweep/1equaldist', 92, 93.5],
            [0.7, '1sweep/1p7dist', 91, 95],
            [0.5, '1sweep/1p5dist', 91, 98],
            [0.4, '1sweep/1p4dist', 90.5, 98],
            [0.3, '1sweep/1p3dist', 90.5, 100],
            [0.2, '1sweep/1p2dist', 90.5, 105],
    ]:
        pkl_fn = fn + '.pkl'
