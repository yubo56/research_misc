...
\end{equation}
Note $E$ is the eccentric anomaly. This differs from the VLF definition by a
factor of $2$, such that $F_{Nm} = \delta_{Nm}$ for $e = 0$; I verified against
...
relates the true/eccentric anomalies.

For moderate $e$, this seems to be easiest to evaluate with a direct integral,
rather than tabulating using recursion coefficients and interpolating; I'll move
