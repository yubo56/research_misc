...
\begin{equation}
    \hat{\tau}_N \equiv F_{N2}^2 \mathrm{sgn}\p*{N - 2\frac{\Omega_s}{\Omega}}
        \abs*{N - 2\frac{\Omega_s}{\Omega}}^{8/3}.
\end{equation}
...
\begin{itemize}
    \item Let $2\Omega_s \ll N_{\max} \Omega$, then the sign term is just the
        sign of $N$, and $\abs*{\pm N - \frac{2\Omega_s}{\Omega}} \approx
        \abs*{N}$. This gives
        \begin{align}
            \tau &\approx T_0 \hat{C}(r_c) \s*{
