...
e}}{\p*{1 - e}^{3/2}}$ for $\alpha \approx 2(1 + e)$, while $f_5 = 1 + 3e^2 +
3e^4/8$):
\begin{itemize}
        ...
        \begin{align}
            \hat{\tau}
                ...
                &\approx -\abs*{1 - \frac{2\Omega_s}{N_{\max}\Omega}}^{8/3}
                    \frac{f_5}{\p*{1 - e^2}^{9/2}}\p*{2\p*{\frac{1 + e}{1 -
                    e}}^{3/2}}^{8/3},\\
                &\approx -\abs*{1 - \frac{2\Omega_s}{N_{\max}\Omega}}^{8/3}
                    \frac{f_52^{8/3}\p*{1 + e}^{4}}{\p*{1 - e^2}^{17/2}}.
        \end{align}
        ...
        \begin{align}
            \hat{\tau}
                ...
                &\approx \abs*{1 - 1.38\frac{\Omega_s}{N_{\max}\Omega}}^{8/3}
                    ...
                    \frac{\Gamma(23/3)}{4!}2^{-8/3}\p*{1 + e}^{4}.
        \end{align}
\end{itemize}
Thus, we arrive at final answer
\begin{equation}
    \hat{\tau} \approx \frac{f_5\p*{1 + e}^4}{\p*{1 - e^2}^{17/2}} \times
    \begin{cases}
        \abs*{1 - 1.38\frac{\Omega_s}{N_{\max}\Omega}}^{8/3}
            \frac{\Gamma(23/3)}{4!}2^{-8/3},
            & \Omega_s < N_{\max}\Omega / 2,\\[5pt]
        -\abs*{1 - 2\frac{\Omega_s}{N_{\max}\Omega}}^{8/3} 2^{8/3},
            & \Omega_s > N_{\max}\Omega / 2.
    \end{cases}\label{eq:traveling_torque}
\end{equation}

TODO we also update the energy expression as well.
