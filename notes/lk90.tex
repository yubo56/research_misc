...
% Below is wrong, looked for standard N = 1/2 resonance by adding/subtracting
% trig terms, it's actually just paremetric w/ N = 1
...
\subsection{Untangling the Parametric Resonance (LL17)}
...
\begin{itemize}
    \item The $90.5^\circ$ Paper II simulation goes from $A \simeq 9^\circ$ to
        ...
        limit, $\Omega_{\rm eff} P_{\rm LK} / (2\pi) \sim 40$, so we have $200$
        precession cycles to transition the precession axis, plenty adiabatic.
...
Updates: (i) we are able to find adiabatic evolution of the resonance, but (ii)
the missing resonance stays missing, even when picking out $\Omega_{\rm eff}
P_{\rm LK} / (2\pi)$ very precisely. It seems we will need to run the spin
evolution for a substantial portion of the mild-Kozai problem. Towards (i), one
last thing we can check are the properties of the N1 component, namely $\psi$
and $\epsilon$.
