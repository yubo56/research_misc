...
$\dot{\Omega}(x)$, so it's easy to integrate.

What about the width of this resonance? Well, I have a new suspicion that it's
actually just a parametric resonance, in which case the width and all may be
easy to compute.
